...
public class demoEmail extends HttpServlet {
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            props.put("mail.from", "am@adam-marsh.com");
            props.put("mail.smtp.username", "am+adam-marsh.com");
            ...
            transport.connect("jupiter.ignitionserver.net", "am@adam-marsh.com", "ironic63");
            transport.send(msg);

            RequestDispatcher dispatcher =
                    getServletContext().getRequestDispatcher(
                            "/pages/play/emailThx.jsp");
...
class SMTPAuthenticatorAlt extends Authenticator {
    protected PasswordAuthentication getPasswordAuthentication() {
        return new PasswordAuthentication("am@adam-marsh.com", "ironic63");
    }
}
